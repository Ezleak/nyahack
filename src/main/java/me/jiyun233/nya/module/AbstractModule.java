...
import me.jiyun233.nya.notification.Notification;
import me.jiyun233.nya.notification.NotificationType;
import me.jiyun233.nya.settings.*;
...
public abstract class AbstractModule {
    ...
    public void enable() {
        if (!this.toggle) {
            ...
            if (NotificationModule.INSTANCE.isEnabled() && NyaHack.notificationsManager != null) {
                NyaHack.notificationsManager.addNotification(new Notification(this.name, this.name +"Toggle enable!", NotificationType.SUCCESS));
            }
            this.onEnable();
        }
    }
    ...
    public void disable() {
        if (this.toggle) {
            ...
            if (NotificationModule.INSTANCE.isEnabled() && NyaHack.notificationsManager != null) {
                NyaHack.notificationsManager.addNotification(new Notification(this.name, this.name + " Toggle disable!", NotificationType.ERROR));
            }
            this.onDisable();
        }
    }
