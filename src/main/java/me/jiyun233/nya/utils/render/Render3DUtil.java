...
public class Render3DUtil extends Tessellator {
    ...
    public static void drawText(Vec3d vec3d, String text, Color color) {
        ...
        GlStateManager.translate(-(NyaHack.fontManager.CustomFont.getWidth(text) / 2.0), 0.0, 0.0);
        NyaHack.fontManager.CustomFont.drawStringWithShadow(text, 0.0f, 0.0f, color.getRGB());
